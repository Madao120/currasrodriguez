...
import { useRoute } from "vue-router"; // Importa useRoute para acceder a los parámetros de la ruta no vale router
...
async function buscar() {
  ...
  try {
    ...
    console.warn("MongoDB articulos no disponible");
  }
